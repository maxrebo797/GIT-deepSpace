(function (window, tinymce, tinyMCE) {
    'use strict';
    ...
    var tinyMCEPopup = {
        ...
        init: function () {
            ...
            // We have manually added this try catch to prevent a cross domain security error from occuring
            // when a user is linked to BCNA from a third party site like Facebook.
            // The error is DOMException: Blocked a frame with origin "http://bcna.local" from accessing a cross-origin frame.
            try {
...
})(window, window.tinymce, window.tinyMCE);
